...
-- Fix admin_add_pix_key function
...
-- Fix admin_set_primary_pix_key function
CREATE OR REPLACE FUNCTION public.admin_set_primary_pix_key(p_pix_key_id uuid)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
...
-- Fix admin_delete_pix_key function
...
-- Fix admin_save_payment_settings function
CREATE OR REPLACE FUNCTION public.admin_save_payment_settings(p_accept_card boolean, p_accept_pix boolean, p_accept_monthly_fee boolean, p_monthly_fee_amount numeric)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
