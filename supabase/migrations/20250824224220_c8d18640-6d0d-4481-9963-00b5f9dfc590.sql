...
-- Admin permissions table - only admins can manage permissions
CREATE POLICY "Only admins can view admin permissions" 
ON public.admin_permissions 
FOR SELECT 
USING (public.is_admin());

CREATE POLICY "Only admins can create admin permissions" 
ON public.admin_permissions 
FOR INSERT 
WITH CHECK (public.is_admin());

CREATE POLICY "Only admins can update admin permissions" 
ON public.admin_permissions 
FOR UPDATE 
USING (public.is_admin());

CREATE POLICY "Only admins can delete admin permissions" 
ON public.admin_permissions 
FOR DELETE 
USING (public.is_admin());
